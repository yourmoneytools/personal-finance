...
<html lang="en">
    <head>
        <title>Personal Finance Blog & Smart Money Tips | Cash Tools</title>
        <meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="Explore personal finance tips, budgeting strategies, saving money, debt, investing, and financial guides | discoverhow  to make smarter money decisions">
        ...
        <meta property="og:title" content="Personal Finance Blog & Smart Money Tips | Cash Tools" />
		<meta property="og:description" content="Explore personal finance tips, budgeting strategies, saving money, debt, investing, and financial guides | discoverhow  to make smarter money decisions" />
    ...
    <body>
        ...
        <div class="page-wrap">
			...
			<div class="wrap content blog-content">
                ...
                <div class="blog-list">
                    ...
                    <div class="blog-block">
                        <a href="/blogs/<?= urlencode($post["slug"]) ?>">
